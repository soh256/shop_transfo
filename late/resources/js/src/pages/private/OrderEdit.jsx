...
export const OrderEdit = () => {
  ...
  const deleteItem = async (productId) => {
    try {
      const { data } = await OrderService.DeleteOrderProduct(id, productId);
      toast.success("Le produit a été retirer de votre commande :)");
    ...
    <div className="h-auto px-3">
      <div className="h-full w-full bg-white rounded flex flex-col  ">
        <div className="w-full h-12 py-3 text-gray-600 uppercase border-b-2 shadow border-gray-300 flex justify-center items-center font-medium text-sm text-normal">
          Commande numero: {order?.order_number}
        </div>
        <div className="py-4 mx-16 flex justify-between mt-14 ">
        ...
        <div className="flex justify-end mb-5 mx-14 ">
